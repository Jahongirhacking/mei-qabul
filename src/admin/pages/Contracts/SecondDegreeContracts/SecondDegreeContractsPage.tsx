...
export default function SecondDegreeContractsPage() {
  ...
  const { download, isDownload } = useDownloadExcelContracts({
    onSuccess: (data) => {
      openLink(URL.createObjectURL(data), "Ikkinchi ta'lim shartnomalari excel")
    }
  })

  return (
    <Container
      title="Ikkinchi ta'lim shartnomalari"
      extra={
        <Space>
