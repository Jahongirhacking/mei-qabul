...
export default function TargetedAdmissionContractsPage() {
  ...
  const { download, isDownload } = useDownloadExcelContracts({
    onSuccess: (data) => {
      openLink(URL.createObjectURL(data), 'Maqsadli qabul shartnomalari excel')
    }
  })

  return (
    <Container
      title="Maqsadli qabul shartnomalari"
      extra={
        <Space>
